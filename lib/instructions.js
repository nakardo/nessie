...
function decrementIdx({cpu}, idx) {
  cpu[idx] = decrement({cpu, src: cpu[idx]});
}

function incrementIdx({cpu}, idx) {
  cpu[idx] = increment({cpu, src: cpu[idx]});
}

function load({cpu, src}, register) {
  cpu.sign(src);
  cpu.zero(src);
  cpu[register] = src;
}

function transfer({cpu}, from, to) {
  const src = cpu[from];
  cpu.sign(src);
  cpu.zero(src);
  cpu[to] = src;
 ...
 * +----------------+-----------------------+---------+---------+----------+
 */
const dex = (...args) => decrementIdx(...args, 'x');
 ...
 * +----------------+-----------------------+---------+---------+----------+
 */
const dey = (...args) => decrementIdx(...args, 'y');
 ...
 * +----------------+-----------------------+---------+---------+----------+
 */
const inx = (...args) => incrementIdx(...args, 'x');
 ...
 * +----------------+-----------------------+---------+---------+----------+
 */
const iny = (...args) => incrementIdx(...args, 'y');
