 ...
 */
export const bcc = branch('carry', false);
 ...
 */
export const bcs = branch('carry', true);
 ...
 * * Add 2 if branch occurs to next page.
 */
export const beq = branch('zero', true);
 ...
 */
export const bmi = branch('sign', true);
 ...
 * * Add 2 if branch occurs to different page.
 */
export const bne = branch('zero', false);
 ...
 * * Add 2 if branch occurs to different page.
 */
export const bpl = branch('sign', false);
 ...
 * * Add 2 if branch occurs to different page.
 */
export const bvc = branch('overflow', false);
 ...
 * * Add 2 if branch occurs to different page.
 */
export const bvs = branch('overflow', true);
